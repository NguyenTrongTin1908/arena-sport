...
export default {
  ...
  teamPosterDir: join(__dirname, '..', '..', 'public', 'teams-poster'),
  teamLogoDir: join(__dirname, '..', '..', 'public', 'teams-logo'),
  teamBannerSupportDir: join(__dirname, '..', '..', 'public', 'team-banner-support'),
